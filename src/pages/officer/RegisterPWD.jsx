...
const OfficerRegisterPWD = () => {
  ...
  useEffect(() => {
    fetch("https://app.dms-api.com/v1/communities")
      .then(res => res.json())
      .then(data => {
    ...
    fetch("https://app.dms-api.com/v1/assistance-types")
      .then(res => res.json())
      .then(data => {
        if (data.status === "success" && data.data) {
    ...
    fetch("https://app.dms-api.com/v1/disability-categories")
      .then(res => res.json())
      .then(data => {
        if (data.status === "success" && data.data) {
  ...
  useEffect(() => {
    if (formData.disabilityCategory) {
      fetch(`https://app.dms-api.com/v1/disability-categories/${formData.disabilityCategory}/types`)
        .then(res => res.json())
        .then(data => {
          if (data.status === "success" && data.data) {
            setTypes(data.data);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch("https://app.dms-api.com/v1/pwd-records", {
        method: "POST",
        headers: {
