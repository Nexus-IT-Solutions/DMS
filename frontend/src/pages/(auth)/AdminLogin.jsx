...
const AdminLogin = () => {
  ...
  return (
    <div className="min-h-screen w-full flex items-stretch bg-gradient-to-br from-teal-300 to-blue-600 dark:from-teal-600 dark:to-blue-900">
      ...
      <div className="hidden md:flex md:w-1/2 relative items-center justify-center bg-gray-200 dark:bg-gray-800">
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center px-6 text-center">
          <h2 className="text-xl md:text-2xl font-bold text-white drop-shadow-lg mb-2">Admin Portal</h2>
          <p className="text-white/90 text-base md:text-lg font-medium">Secure access for administrators</p>
        </div>
      </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div>
              ...
              <div className="flex justify-end items-center mt-2">
                <a href="/admin-forgot-password" className="text-sm text-teal-600 hover:underline dark:text-teal-400">Forgot password?</a>
  <Link to="/admin-forgot-password" className="text-sm text-teal-600 hover:underline dark:text-teal-400">Forgot password?</Link>
  <Link to="/admin-forgot-password" className="text-sm text-teal-600 hover:underline dark:text-teal-400">Forgot password?</Link>
              </div>
            </div>
