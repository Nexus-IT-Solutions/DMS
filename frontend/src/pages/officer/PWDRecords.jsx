...
export default function OfficerPWDRecords() {
              ...
              filteredData.map((record) => (
                ...
                >
                  ...
                  <td className="px-4 py-3 space-x-3">
                    <button
                      onClick={() =>
                        navigate(`/officer-dashboard/records/${record.pwd_id}`)
                      }
                    ...
                    <button
                      onClick={() => navigate(`/officer-dashboard/records/edit/${record.pwd_id}`)}
